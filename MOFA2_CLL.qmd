...
- **Factor 1** captures a source of variability that is present in more than 3 data modalities. Thus, they may represent etiologies that is important for the disease.  
...
**(Q) Your task is to provide a characterisation for Factor 5**.  

Try a similar pipeline as for Factor 1 and answer the following questions:  
- Which mutation underlies Factor 5?  
...
**(Q) Can you characterise Factor 3 based on the GSEA results? Which genes are driving the top enriched pathways?**  
Hint: use the functions `plot_enrichment`

**(Q) Which drugs are associated with Factor 3? What is their target pathway? Do they make biological sense?**  
...
### (Q) Provide a characterisation for Factor 5
